...
const DATOS = (catID) =>  `http://localhost:3000/api/categories/products/${catID}`;
const PRODUCT_INFO = (id) => `http://localhost:3000/api/products/${id}`; 
const COMMENTS = (id) => `http://localhost:3000/api/products/comments/${id}`; 
